(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://sameep1234.github.io/notes/notes/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://sameep1234.github.io/notes/notes/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://sameep1234.github.io/notes/notes/assets/css/just-the-docs-' + theme + ".css"
      );
    };
