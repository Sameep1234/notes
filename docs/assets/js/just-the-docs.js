(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://sameep1234.github.io/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://sameep1234.github.io/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://sameep1234.github.io/assets/css/just-the-docs-' + theme + ".css"
      );
    };
